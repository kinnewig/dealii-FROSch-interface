...
namespace FROSch {
    ...
    OptimizedSchwarzOperator<SC,LO,GO,NO>::initialize()
    {
        FROSCH_TIMER_START_LEVELID(
            initializeTime, 
            "OptimizedSchwarzOperator::initialize");

        FROSCH_ASSERT(false, "OptimizedSchwarzOperator cannot be built without input parameters.");
    }
    ...
    OptimizedSchwarzOperator<SC,LO,GO,NO>::compute()
    {
        FROSCH_TIMER_START_LEVELID(
            computeTime,
            "OptimizedSchwarzOperator::compute");

        FROSCH_ASSERT(this->IsInitialized_,
                      "ERROR: OptimizedSchwarzOperator has to be initialized before calling compute()");
    ...
    template <class SC,class LO,class GO,class NO>
    int 
    OptimizedSchwarzOperator<SC,LO,GO,NO>::compute(ConstXMatrixPtr neumannMatrix, ConstXMatrixPtr robinMatrix)
    {
        FROSCH_TIMER_START_LEVELID(
            computeTime,
            "OptimizedSchwarzOperator::compute");
    ...
    template <class SC,class LO,class GO,class NO>
    void 
    OptimizedSchwarzOperator<SC,LO,GO,NO>::describe(
        FancyOStream          &/*out*/,
        const EVerbosityLevel  /*verbLevel*/) const
    {
        FROSCH_ASSERT(false,"OptimizedSchwarzOperator::describe() is not available.");
    }
    ...
    template <class SC,class LO,class GO,class NO>
    string 
    OptimizedSchwarzOperator<SC,LO,GO,NO>::description() const
    {
    ...
    OptimizedSchwarzOperator<SC,LO,GO,NO>::buildOverlappingMap(int overlap)
    {
        FROSCH_DETAILTIMER_START_LEVELID(
            ...
            "OptimizedSchwarzOperator::buildOverlappingMatrices");
    ...
    template <class SC,class LO,class GO,class NO>
    int 
    OptimizedSchwarzOperator<SC,LO,GO,NO>::updateLocalOverlappingMatrices()
    {
        FROSCH_DETAILTIMER_START_LEVELID(
            updateLocalOverlappingMatricesTime,
            "OptimizedSchwarzOperator::updateLocalOverlappingMatrices");
        ...
        // For debugging: Print the subsystem matrix:
        //int rank;
    ...
    template <class SC,class LO,class GO,class NO>
    int 
    OptimizedSchwarzOperator<SC,LO,GO,NO>::updateLocalOverlappingMatrices_Symbolic()
    {
        FROSCH_DETAILTIMER_START_LEVELID(
            updateLocalOverlappingMatrices_SymbolicTime, 
            "OptimizedSchwarzOperator::updateLocalOverlappingMatrices_Symbolic");
    ...
    template <class SC,class LO,class GO,class NO>
    void 
    OptimizedSchwarzOperator<SC,LO,GO,NO>::extractLocalSubdomainMatrix_Symbolic()
    {
