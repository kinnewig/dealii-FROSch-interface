...
public:
   ...
   *
   * @param triangulation The global dealii::parallel::shared::Triangulation from deal.II.
   */
  void
  export_crs(const parallel::shared::Triangulation<dim> &triangulation);
   ...
   * dealii::DoFHandler and the dealii::parallel::shared::Triangulation
  ...
  /**
   * This function creates the overlapping map, i.e., which global_dof index lies
...
private:
  ...
  extract_point_list(Teuchos::RCP<LA::XpetraTypes::MultiVectorType<double, MemorySpace>> mv);
